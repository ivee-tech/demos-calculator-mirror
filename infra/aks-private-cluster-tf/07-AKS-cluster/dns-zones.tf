...
data "azurerm_private_dns_zone" "aks-dns" {
  name                = var.private_dns_zone_name
  resource_group_name = var.private_dns_zone_name_resource_group_name
}

output "aks_private_zone_id" {
  value = data.azurerm_private_dns_zone.aks-dns.id
}
output "aks_private_zone_name" {
  value = data.azurerm_private_dns_zone.aks-dns.name
}