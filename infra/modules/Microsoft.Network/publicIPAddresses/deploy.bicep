...
@minValue(0)
@maxValue(365)
param diagnosticLogsRetentionInDays int = 0 // 365, it seems that a value different than 0 is causing problems: see https://github.com/Azure/ResourceModules/issues/3572
